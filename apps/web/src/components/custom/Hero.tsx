    ...
    return (
        <div className="flex justify-items-center items-center align-middle pt-16 flex-col text-center gap-y-7">
            ...
            <div>
                ...
                <p className="text-5xl sm:text-7xl font-bold bg-gradient-to-r from-[#c1f94c] to-[#fcd44c] min-h-24 bg-clip-text text-transparent">Secure Crypto Wallet</p>
            </div>
            <p className="w-[90%] md:w-[50%] text-md sm:text-lg text-gray-300">Store, send and secure your crypto assets effortlessly with Kura. Experience strong encryption, fast transactions 
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-y-0 gap-x-6">
                <Button className="bg-[#b8ff4c] p-6 text-lg font text-black cursor-pointer hover:scale-105"><p className="flex gap-x-2"><Laptop2 className="my-auto"/> Use Web Wallet</p></Button>
            ...
            <div className="sm:-mt-10 mx-3">
                <Image src={"/mac.svg"} alt="Laptop Mockup" width={300} height={300} className="max-w-7xl w-full h-auto rounded-xl shadow-lg" />
            </div>
        </div>
    );
}